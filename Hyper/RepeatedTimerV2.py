    ...
    def stop(self):
        ...
        try:    
            ...
            for f in listResponse:
                if 'raw' in f: #Se guardan los ficheros en local, se tienen que almacenar los metadatos en el nombre
                    filename = "HIM_timestamp" + str(timestamp)
                    filepath = "/home/vera/HyperAgro/Green_visor/saving/HIM/" + filename
